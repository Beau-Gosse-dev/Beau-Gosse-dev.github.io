...
The gallery brings together bracelet sizing cones, the Cedarburg HO house and garage, the Revision 3 expansion-band stretcher, a Hoyer 6000-series replacement bezel, a LEGO-style brick wall shelf, watch-cleaning baskets, and a Mahjong line reader aid. Original model filenames are preserved. `source-files.json` records SHA-256 hashes for 94 imported files; edited instructions also retain their original source hashes and a change note. The standalone 19 mm insert file was removed from the public downloads; the 16–20 mm set includes the 19 mm pair.
